...
class Excel
{
    ...
    public function __construct($excelFilePath = null, $useHeaders = true, $headersInLowCase = true)
    {
        if ($excelFilePath) {
            //Include Library
            require_once Jin::getJinPath().Jin::getRelativePathExtLibs() . 'phpexcel/PHPExcel/IOFactory.php';
    ...
    {
        //Include Library
        require_once Jin::getJinPath().Jin::getRelativePathExtLibs() . 'phpexcel/PHPExcel.php';
