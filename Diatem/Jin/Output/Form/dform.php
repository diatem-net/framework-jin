...
class DForm
{
    ...
    * @param \Diatem\Jin\Output\Components\Form\AttachementFile $fileComponent    Composant AttachementFile
    ...
    */
    public function getFieldValue($fieldName)
    {
        if (isset($this->fields[$fieldName])) {
            ...
            } elseif (!isset($this->fields[$fieldName]['value']) && !empty($_POST)) {
                //cas particulier checkbox
                return array();
            } elseif (isset($this->fields[$fieldName]['value'])) {
                return $this->fields[$fieldName]['value'];
            } else {
                return $this->fields[$fieldName]['defaultValue'];
            }
        } elseif (isset($this->attachementFields[$fieldName])) {
    ...
    */
    public function renderComponentField($fieldName, $globalErrorFormat = '<div class="error">%texte%</div>', $itemErrorFormat = '<span>%texte%</span>')
    {
        ...
        } elseif (isset($this->attachementFields[$fieldName]['component'])) {
