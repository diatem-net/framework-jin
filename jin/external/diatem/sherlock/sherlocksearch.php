...
class SherlockSearch extends SherlockCore{
	...
	if(count($this->criterias) > 0){
	    ...
	    $callParams['query']['bool']['should'] = array();
	    foreach($this->criterias as $criteria){
		$callParams['query']['bool']['should'] = ArrayTools::mergeArrays($callParams['query']['bool']['should'], $criteria->getParamArray()); 
	    }
	...
	if(count($this->conditions) > 0){
		...
		$callParams['query']['constant_score']['filter'][$this->conditionOperator] = ArrayTools::mergeArrays($callParams['query']['constant_score']['filter'][$this->conditionOperator], $condition->getParamArray()); 
	    }
	}
