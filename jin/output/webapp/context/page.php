...
class Page{
    ...
    private function setController(){
       if(is_file($this->getRootPath().'controller/'.$this->getMethod().'/'.$this->getCode().'_controller.php')){
           //Controler method
           include $this->getRootPath().'controller/'.$this->getMethod().'/'.$this->getCode().'_controller.php';
           $classPath = '\\'.$this->getCode().'_controller';
           $this->controller = new $classPath();
       }else if($this->getMethod() != 'GET' && is_file($this->getRootPath().'controller/GET/'.$this->getCode().'_controller.php')){
           //Default controller GET
           include $this->getRootPath().'controller/GET/'.$this->getCode().'_controller.php';
           $classPath = '\\'.$this->getCode().'_controller';
           $this->controller = new $classPath();
       }else if(is_file($this->getRootPath().'controller/'.$this->getCode().'_controller.php')){
           include $this->getRootPath().'controller/'.$this->getCode().'_controller.php';
           $classPath = '\\'.$this->getCode().'_controller';
           $this->controller = new $classPath();
       }else if(is_file($this->getRootPath().''.$this->getCode().'_controller.php')){
           //Root controller
           include $this->getRootPath().''.$this->getCode().'_controller.php';
           $classPath = '\\'.$this->getCode().'_controller';
           $this->controller = new $classPath();
       }else{
